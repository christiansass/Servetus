...
Servetus/00-source/YYYY/MM-Mon/DD/<source>/ ← evidence locker, original names, date-sorted
        ↓ Servetus processes
Servetus/01-artifacts/YYYY/MM-Mon/          ← Markdown field record, Servetus naming
        +
...
|---|---|---|
| Raw source file (any format) | `00-source/YYYY/MM-Mon/DD/<source>/` | Original name, copied from root Inbox |
| Artifact field record (.md) | `01-artifacts/YYYY/MM-Mon/` | Servetus naming, processed from 00-source |
