...
|---|---|---|
| Voice/audio transcript (.md) | `01-witnesses/YYYY/MM-MonthName/YYYY-MM-DD/` | Lightroom date hierarchy |
| Audio file (.m4a, .mp3) | `01-witnesses/YYYY/MM-MonthName/YYYY-MM-DD/` | Same folder as transcript |
| Source export (.docx) | `01-witnesses/YYYY/MM-MonthName/YYYY-MM-DD/` | Same folder as transcript |
| Atomic concept note | `02-daily-logs/` | Flat, no subfolders |
| Daily/session log | `02-daily-logs/` | `YYYY-MM-DD-servetus-log.md` |
| ChatGPT thread export (processed) | `02-daily-logs/` | Flat, no subfolders |
